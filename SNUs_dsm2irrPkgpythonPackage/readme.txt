SNUs_dsm2irrPkg MATLAB Python Package
...
2. Installing the SNUs_dsm2irrPkg Package

A. Change to the directory that contains the file setup.py and the subdirectory 
SNUs_dsm2irrPkg. If you do not have write permissions, copy all its contents to a 
...
3. Using the SNUs_dsm2irrPkg Package

The SNUs_dsm2irrPkg package is on your Python path. To import it into a Python script or 
session, execute:
